...
- Connexion admin simple par mot de passe pour les organisateurs, par defaut `mdp`
...
- `ADMIN_PASSWORD` : mot de passe simple partagé aux organisateurs, par defaut `mdp`
